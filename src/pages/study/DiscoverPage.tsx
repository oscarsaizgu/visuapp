  ...
  return (
    <div className={styles.page}>
      ...
      <header>
        ...
        <p className={styles.lead}>Ejemplares que aún no has visto. Al abrir su ficha pasan a tu colección.</p>
      </header>
      {nuevos.length ? (
        ...
        <p className={styles.empty}>Has descubierto todos los ejemplares activos.</p>
      )}
    </div>
  );
}
