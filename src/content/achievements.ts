...
import { Binoculars, Eye, Fire, Flame, Lightning, Medal, Seal, Sparkle, Target, Timer, Trophy, Crown, Star, Books } from '@phosphor-icons/react';
...
export const INSIGNIAS: Insignia[] = [
  ...
  {
    id: 'cazador-fosiles', titulo: 'Cazador de fósiles', descripcion: 'Acierta al menos una vez cada fósil activo.', icono: Binoculars,
    progreso: (s) => [n(s.distintosAcertadosPorCategoria.fosiles), Math.max(1, n(s.totalPorCategoria.fosiles))],
  },
  { id: 'coleccion-completa', titulo: 'Colección completa', descripcion: 'Descubre todos los ejemplares activos.', icono: Trophy, progreso: (s) => [s.descubiertos, Math.max(1, s.totalActivos)] },
  { id: 'estudiados-50', titulo: '50 especies estudiadas', descripcion: 'Identifica en el juego 50 ejemplares distintos. Necesita más de 50 ejemplares activos.', icono: Books, progreso: (s) => [s.estudiados, 50] },
  ...CATEGORIAS.flatMap((c): Insignia[] => [
    ...
    {
      id: `maestro-${c.id}`, titulo: `Maestro de ${c.nombre}`, descripcion: `Domina todos los ejemplares activos de ${c.nombre}.`, icono: c.icono,
